        ...
        <aside className="w-64 bg-gray-800/30 backdrop-blur-sm border-r border-gray-700/50 flex flex-col">
          ...
          <nav className="flex-1 p-4 overflow-y-auto">
            ...
            <div className="space-y-2 mb-6">
              {/* All Items */}
              <button className="w-full flex items-center gap-3 px-3 py-2 text-white bg-gray-700/50 rounded-lg hover:bg-gray-700/70 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
                <span className="font-medium">All Items</span>
                <span className="ml-auto text-xs text-gray-400 bg-gray-700/50 px-2 py-1 rounded-full">0</span>
              </button>

              <button className="w-full flex items-center gap-3 px-3 py-2 text-gray-400 rounded-lg hover:bg-gray-700/30 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                </svg>
                <span className="font-medium">Favorites</span>
                <span className="ml-auto text-xs text-gray-500 bg-gray-700/30 px-2 py-1 rounded-full">0</span>
              </button>
